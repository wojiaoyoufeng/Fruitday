...
@interface SheQuDetailDataModel : FDBaseDataModel
{
...
@property(copy, nonatomic) NSString<Optional> *can_delete; // @synthesize can_delete=_can_delete;
