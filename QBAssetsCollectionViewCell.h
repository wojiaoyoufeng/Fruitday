...
@class ALAsset, QBAssetsCollectionOverlayView, UIImageView;
...
@interface QBAssetsCollectionViewCell : UICollectionViewCell
{
    ...
    QBAssetsCollectionOverlayView *_overlayView;
}

@property(retain, nonatomic) QBAssetsCollectionOverlayView *overlayView; // @synthesize overlayView=_overlayView;
