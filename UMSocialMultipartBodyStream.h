...
@class NSEnumerator, NSError, NSMutableArray, NSMutableData, NSOutputStream, NSString, UMSocialHTTPBodyPart;

@interface UMSocialMultipartBodyStream : NSInputStream <NSCopying, NSStreamDelegate>
{
    ...
    UMSocialHTTPBodyPart *_currentHTTPBodyPart;
...
@property(retain, nonatomic) UMSocialHTTPBodyPart *currentHTTPBodyPart; // @synthesize currentHTTPBodyPart=_currentHTTPBodyPart;
