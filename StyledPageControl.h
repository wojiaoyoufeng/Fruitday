...
@property(nonatomic) float bottomDistance; // @synthesize bottomDistance=_bottomDistance;
...
@property(nonatomic) int pageControlSite; // @synthesize pageControlSite=_pageControlSite;
