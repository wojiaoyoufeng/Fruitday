...
#import "UMSocialURLSessionManager.h"

#import "NSCopying.h"
#import "NSSecureCoding.h"

@class NSURL, UMSocialHTTPRequestSerializer<UMSocialURLRequestSerialization>, UMSocialHTTPResponseSerializer<UMSocialURLResponseSerialization>;

@interface UMSocialHTTPSessionManager : UMSocialURLSessionManager <NSSecureCoding, NSCopying>
{
    NSURL *_baseURL;
...
@property(retain, nonatomic) UMSocialHTTPResponseSerializer<UMSocialURLResponseSerialization> *responseSerializer; // @dynamic responseSerializer;
