...
@interface MJRefreshHeader : MJRefreshComponent
{
    ...
    double _refreshFastAnimationDuration;
}

+ (id)headerWithRefreshingTarget:(id)arg1 refreshingAction:(SEL)arg2;
+ (id)headerWithRefreshingBlock:(CDUnknownBlockType)arg1;
@property(nonatomic) double refreshFastAnimationDuration; // @synthesize refreshFastAnimationDuration=_refreshFastAnimationDuration;
