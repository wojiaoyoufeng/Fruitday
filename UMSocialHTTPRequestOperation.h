...
#import "UMSocialURLConnectionOperation.h"

@class NSError, NSHTTPURLResponse, NSRecursiveLock, UMSocialHTTPResponseSerializer<UMSocialURLResponseSerialization>;

@interface UMSocialHTTPRequestOperation : UMSocialURLConnectionOperation
{
