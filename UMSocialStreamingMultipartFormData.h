...
#import "UMSocialMultipartFormData.h"

@class NSMutableURLRequest, NSString, UMSocialMultipartBodyStream;

@interface UMSocialStreamingMultipartFormData : NSObject <UMSocialMultipartFormData>
{
    NSMutableURLRequest *_request;
    unsigned long long _stringEncoding;
    NSString *_boundary;
    UMSocialMultipartBodyStream *_bodyStream;
}

@property(retain, nonatomic) UMSocialMultipartBodyStream *bodyStream; // @synthesize bodyStream=_bodyStream;
