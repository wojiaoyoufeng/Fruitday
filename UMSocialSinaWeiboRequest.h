...
@class NSDictionary, NSMutableData, NSString, NSURLConnection, UMSocialSinaWeibo;

@interface UMSocialSinaWeiboRequest : NSObject
{
    UMSocialSinaWeibo *sinaweibo;
    NSString *url;
    NSString *httpMethod;
    NSDictionary *params;
    NSURLConnection *connection;
    NSMutableData *responseData;
    id <UMSocialSinaWeiboRequestDelegate> delegate;
}
...
@property(nonatomic) id <UMSocialSinaWeiboRequestDelegate> delegate; // @synthesize delegate;
...
@property(nonatomic) UMSocialSinaWeibo *sinaweibo; // @synthesize sinaweibo;
- (void).cxx_destruct;
